...
import org.halle.constant.IpConstant;
import org.halle.util.AsciiStringUtil;
import org.halle.util.CrcUtil;
import org.halle.util.Endpoint;
...
public class PeerId implements Copiable<PeerId>, Serializable, Checksum {
    ...
    /** Peer address. */
    private Endpoint endpoint         = new Endpoint(IpConstant.IP_ANY, 0);
    ...
    public boolean isEmpty() {
        return getIp().equals(IpConstant.IP_ANY) && getPort() == 0 && this.idx == 0;
    }
